		...
		<td width="80%" valign="top">
			...
			<c:forEach items="${fanclubs}" var="fanclub">
				<div class="responsive-player">
					<div class="gallery">
						<a href="detail/${fanclub.id}">
							<img src="<c:url value="/img/${fanclub.id}.jpg" />" alt="image"  width="300" height="200" />
						</a>
						<div class="desc">
							<strong>${ fanclub.name }</strong><br />
							${fanclub.description}<br />
							<a class="player_edit" href="${url}/edit/${fanclub.id}">Edit</a>
							<a class="player_delete" onclick="delete(${fanclub.id)">Delete</a>
						</div>
					</div>
				</div>
			</c:forEach>
